...
var LinkCheker = /** @class */ (function () {
    function LinkCheker() {
        this.FileArray = [];
    }
    LinkCheker.prototype.initialize = function () {
        var object = new LinkCheker();
        var __dirname = "D:/Office/public/bis";
        var directoryPath = path.join(__dirname, 'domains');
...
function Walker() {
    return __awaiter(this, void 0, void 0, function () {
        var obj1, files, __dirname, walker;
        return __generator(this, function (_a) {
            obj1 = new LinkCheker();
            files = [];
            __dirname = "D:/Office/public/bis/domains/";
            walker = walk.walk(__dirname, { followLinks: true });
